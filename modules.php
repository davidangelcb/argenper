...
<div class="boxMenu" title="Genera Templates o Editalos">
    <figure  onclick="menuActive(3)">
        <img src="media/menu/template.png" alt="" />                                              
        <figcaption>Grabaciones</figcaption>
    </figure>
</div>
<div class="boxMenu" title="Enviar un SMS a cuaquier Numero">
    <figure   onclick="menuActive(2)">
        <img src="media/menu/sms.png" alt="" />                                              
