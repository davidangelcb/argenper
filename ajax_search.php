...
function loadTemplate()
{
        ...
        $html='<label for="input-nombre" class="contacTitles">Grabacion:</label><select onchange="" id="templateActive" name="nombre" style="width: 325px;"  class="btnForm"><option value="0">-- Ninguno --</option>';
